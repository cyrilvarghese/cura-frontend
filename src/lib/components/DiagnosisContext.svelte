...
<div class="space-y-8 max-w-4xl mx-auto">
    ...
    <div
        class="bg-white dark:bg-gray-800 p-5 rounded-sm shadow-md border-l-2 border-teal-200"
    >
        <h3
            class="text-lg font-semibold mb-3 text-teal-600 dark:text-teal-300 flex items-center gap-2"
        >
